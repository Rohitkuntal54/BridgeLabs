...
public class ques_4 {
    ...
    public static void main(String[] args) {
        ...
        int[] indices = findShortestLongest(wordsLengths);

        System.out.println("\nShortest word: " + wordsLengths[indices[0]][0] + " (Length: " + wordsLengths[indices[0]][1] + ")");
        System.out.println("Longest word: " + wordsLengths[indices[1]][0] + " (Length: " + wordsLengths[indices[1]][1] + ")");
